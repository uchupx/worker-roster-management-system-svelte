...
<div class="flex h-screen">
  ...
  <div class="flex-1 bg-gray-100 p-6">
    ...
    <form on:submit={handleSubmit} class="max-w-md space-y-4">
      ...
      <div>
        <label for="start_time" class="block text-sm font-medium text-gray-700">Start Time (24-hour format)</label>
        <input
          type="time"
          id="start_time"
      ...
      <div>
        <label for="end_time" class="block text-sm font-medium text-gray-700">End Time (24-hour format)</label>
        <input
          type="time"
          id="end_time"
          bind:value={endTime}
